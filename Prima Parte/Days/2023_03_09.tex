\days{9 marzo 2023}
\newcommand{\settingH}{%
    Sia dato il problema di Cauchy \begin{align*}
            \begin{cases}
                \mathbf{u}'(t)=\mathbf{f}\left(t,\mathbf{u}(t)\right)\\ 
                \mathbf{u}(t_0)= \mathbf{x}_0
            \end{cases} && (t_0,\mathbf{x}_0) \in \Omega
        \end{align*}
        con $ \mathbf{f}: \Omega \subseteq \mathbb{R}\times \mathbb{R}^{n}\to \mathbb{R}^{n}$ continua e localmente lipschitziana nella seconda variabile e uniformemente nella prima.
    }
